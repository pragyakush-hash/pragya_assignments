...
//Generic
//Generics are a powerful feature in TypeScript that help us create reusable code which works with different data types while keeping type safety.

// function identity<T>(arg: T): T {
//   return arg;
// }

//<T> T CAN BE ANY TYPE OF PARAMENTER 
