...
const Movies = () => {
    ...
    const fetchData = async () => {
      try {
        const response = await fetch(
          // "http://www.omdbapi.com/?i=tt3896198&apikey=73860d01"
  ...
  return (
    <div className="flex flex-row flex-wrap">
      {apiData.map((item) => (
        <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700 m-5" key={item.id}>
          <a href="#">
            <img className="rounded-t-lg" src={item.backdrop_path} alt="" />
          </a>
          <div className="p-5">
            <a href="#">
