          ...
          <div className="bg-neutral-primary-soft block max-w-sm border border-default rounded-base shadow-xs">
            <Link to="">
              <img
                ...
                src="https://tfcakes.in/images/products/210111_020233_646_461.jpg"
                alt=""
              />
            </Link>
            <div className="p-6 text-center">
              ...
              <Link
                to="#"
                className="inline-flex items-center text-brown bg-brand box-border border border-transparent hover:bg-brand-strong focus:ring-4 focus:ring-brand-medium shadow-xs font-medium leading-5 rounded-base text-sm px-4 py-2.5 focus:outline-none"
              >
                Read more
              </Link>
            </div>
        ...
        <SwiperSlide>
          <div className="bg-neutral-primary-soft block max-w-sm border border-default rounded-base shadow-xs">
            <Link to="#">
              <img
                className="rounded-t-base"
                src="https://c2hcdn.cake2homes.com/img/2022/03/29/20/17_29_65726.jpg"
                alt=""
              />
            </Link>
            <div className="p-6 text-center">
